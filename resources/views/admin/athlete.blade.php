    ...
    <div class="row justify-content-center mt-0">
        <div class="card px-0 pt-4 pb-0 mt-3 mb-3">
          <div class="d-flex flex-row justify-content-between">
            ...
            <div class="p-2">
              <a class="btn bg-gradient-light" href="{{ route('card-athlete', $athlete->id) }}" target="_blank"><i class="fas fa-lg fa-id-card-alt"></i></a>
              <button class="btn bg-gradient-primary" onClick="window.print()" type="button" name="button"><i class="fa fa-lg fa-print"></i></button>
