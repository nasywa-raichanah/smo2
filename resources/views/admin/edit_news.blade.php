  ...
  <div class="row">
    <div class="col-lg-9 col-12 mx-auto">
      <div class="card card-body mt-4">
        ...
        <form method="POST" action="{{ route('news.edit.process', $post->slug) }}" enctype="multipart/form-data">
          @method('patch')
          @csrf
          <div class="row mt-2">
            <div class="col">
              <label for="title" class="form-label">Title</label>
              <input name="title" type="text" class="form-control @error('title') is-invalid @enderror" id="title" placeholder="Type a title" required autofocus value="{{ $post->title }}">
              @error('title')
          ...
          <div class="row mt-2">
            <div class="col-6">
              ...
              <input id="author" name="author" class="form-control @error('author') is-invalid @enderror" type="text" placeholder="Type your name" required value="{{ $post->author }}">
              @error('author')
                <div class="invalid-feedback">
                  {{ $message }}
                </div>
