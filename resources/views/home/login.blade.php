                            ...
                            <div class="card-body pt-3">
                                <div class="row justify-content-center">
                                    <div class="col-lg-8">
                                        ...
                                        <h5 class="text-center font-weight-bold text-warning">LOGIN PAGE</h5>
                                    </div>
                                </div>
                                @if (session('success'))
                                ...
                                @endif
                                <form action="{{ route('login.store') }}" method="POST" class="mt-3 mb-4 login-input">
                                    @csrf
                                ...
                                <p class="text-center">Don't have account? <a href="/register" class="text-primary">Register</a> now</p>
                            </div>
                        </div>
                    </div>
                </div>
